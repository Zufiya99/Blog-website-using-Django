...
def search(request):
    if request.method == "POST":
        searched_item = request.POST['searched']
        blogs = BlogPost.objects.filter(title__contains=searched_item)
        context = {'searched': True, 'blogs': blogs, 'searched_item': searched_item}
